  ...
  const createShortUrlHandler = async (data) => {
    ...
    try {
        const { data: res } = await api.post("/api/urls/shorten", data, {
          ...
          const shortenUrl = `${baseUrl}/s/${res.shortUrl}`;
    ...
    <form
      ...
      >
        ...
        <button
          ...
          className="bg-gradient-to-r from-blue-500 to-purple-600 font-semibold text-white w-32 py-2 transition-colors rounded-md my-3 hover:opacity-90"
          type="text"
        >
