...
const Navbar = () => {
  ...
  return (
    // <div className="h-16 bg-blue-500  z-50 flex items-center sticky top-0 shadow-lg">
    <div className="h-16 bg-gradient-to-r from-blue-500 to-purple-600 z-50 flex items-center fixed top-0 w-full shadow-lg">
